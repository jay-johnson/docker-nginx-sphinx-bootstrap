...
project = u'Home'
copyright = u'2016 YOUR NAME HERE'
...
texinfo_documents = [
  ('index', 'MyBlog', u'MyBlog',
   u'YOUR NAME HERE', 'MyBlog', 'My blog and resume',
   'Miscellaneous'),
]
